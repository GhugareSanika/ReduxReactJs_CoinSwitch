  ...
  return (
    <Row gutter={[24, 24]}>
      {!simplified && (
        ...
        >
            <Option data="Cryptocurency">Cryptocurrency</Option>
            {data?.data?.coins?.map((currency) => <Option data={currency.title}>{currency.title}</Option>)}
          </Select>
        </Col>
      )}
...
// <div>
 ...
 // </div>
  //<Text>{moment(news.createdAt)}</Text>
//</div>
export default News;